...
import { fetchCandyMachine, mintV2, mplCandyMachine, DefaultGuardSetMintArgs, safeFetchCandyGuard } from "@metaplex-foundation/mpl-candy-machine";
...
const destination = publicKey(process.env.NEXT_PUBLIC_DESTINATION);
const token = publicKey(process.env.NEXT_PUBLIC_TOKEN);
